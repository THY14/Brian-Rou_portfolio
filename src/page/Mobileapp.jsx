...
const Mobileapp = () => {
  return (
    <div className="w-screen  pl-4 pr-4  md:w-full  lg:w-full xl:pl-13 xl:pr-12  py-12  flex flex-col gap-2 md:gap-4 items-center -mt-3 md:mt-6  lg:mt-8">
      ...
      <div className="md:hidden grid grid-cols-4 gap-2 w-auto md:ml-0 gap-x-1">
        <img src={img1} alt="Welcome page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img2} alt="Sign up page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img3} alt="Sign in page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img4} alt="Home page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
      </div>

      <div className="md:hidden grid grid-cols-4 gap-2 w-auto  md:ml-0 gap-x-1 mt-3">
        <img src={img5} alt="Corfey homepage" className="w-full h-auto aspect-[158/290] object-cover object-top shadow-2xl" />
        <img src={img6} alt="HOME PAGE PRO IOS APP" className="w-full h-auto aspect-[158/290] object-cover object-bottom shadow-2xl" />
        <img src={img7} alt="PLAN" className="w-full h-auto aspect-[158/290] object-cover object-bottom  shadow-2xl" />
        <img src={img8} alt="PAYMENT DATA" className="w-full h-full aspect-[158/275] object-cover  shadow-2xl" />
      </div>

      <div className="md:hidden grid grid-cols-4 gap-2 w-auto  md:ml-0 gap-x-1 mt-3 ">
        <img src={img9} alt="Car detail page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img10} alt="Search page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img11} alt="Shopping Cart page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
        <img src={img12} alt="Profile page" className="w-full h-auto aspect-[158/311] object-cover object-top shadow-2xl" />
      </div>

      <div className="md:hidden grid grid-cols-4 gap-2 w-auto  md:ml-0 gap-x-1 mt-3">
        <img src={img13} alt="WELCOME PAGE" className="w-full h-full aspect-[158/290] object-cover shadow-2xl" />
        <img src={img14} alt="HOME PAGE" className="w-full h-full aspect-[158/295] object-cover object-bottom shadow-2xl" />
        <img src={img15} alt="PRODUCT DETAILS" className="w-full h-auto aspect-[158/290] object-cover shadow-2xl " />
        <img src={img16} alt="CART PAGE" className="w-full h-full aspect-[158/290] object-cover  shadow-2xl" />
      </div>
    </div>
  );
};
